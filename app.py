...
# ==========================================
# 3. AI 核心 (✅ 回归 stream: False，彻底解决拼接问题)
# ==========================================
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if res_json.get('code') != 0:
                return f"⚠️ 系统提示：{res_json.get('msg')}"
            messages = res_json.get('data', [])
            for msg in messages:
                if msg.get('type') == 'answer':
                    return msg['content']  # ✅ 找到第一个就 return，绝不重复
            return "🤔 AI 没有回应，请重试。"
        else:
            return f"⚠️ 网络错误: {response.status_code}"
    except Exception as e:
        return f"⚠️ 出错: {str(e)}"
...
if 'user_name' not in st.session_state:
    ...
    with col2:
        ...
        name_input = st.text_input("你的姓名 (拼音或英文):")
